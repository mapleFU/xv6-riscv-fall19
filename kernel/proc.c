...
// allocates a kernel stack for each process.
// It maps each stack at the virtual address generated by KSTACK,
//  which leaves room for the invalid stack-guard pages.
// kvmmap adds the mapping PTEs to the kernel page table,
//  and the call to kvminithart reloads the kernel page table into satp
